...
object SliderDefaults {
    @Composable
    fun colors(
        thumbColor: Color = AiyoTheme.colors.primary,
        activeTrackColor: Color = AiyoTheme.colors.primary,
        activeTickColor: Color = AiyoTheme.colors.onPrimary,
        inactiveTrackColor: Color = AiyoTheme.colors.secondary,
        inactiveTickColor: Color = AiyoTheme.colors.primary,
        disabledThumbColor: Color = AiyoTheme.colors.disabled,
